            ...
            <>
              <tr key={user?.id}>
                ...
                <td className='text-center'>
                  ...
                  {user?.isActivated ?
                    <button onClick={()=> toggleUser(user?.id)} className="block bg-success ms-3"> Block </button>
                  : <button onClick={()=> toggleUser(user?.id)} className="unBlockBtn bg-danger ms-3"> Un Block </button>                
                  }
                </td>
              </tr>
            </>
