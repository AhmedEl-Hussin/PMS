...
export default function Tasks() {
  ...
  const taskStatus = (tasksList)=> {
    if (tasksList.status == "ToDo") {
      return  <div className="bg-info text-white w-50 text-center rounded-5"> 
                <span className="fw-bold"> to do </span> 
              </div>
      
    }else if (tasksList.status == "InProgress") {
      return  <div className="shareColor text-white w-75 text-center rounded-5"> 
                <span className="fw-bold"> in progress </span> 
              </div>
    
    }else if (tasksList.status == "Done") {
      return  <div className="bg-success text-white w-50 text-center rounded-5"> 
      ...
      {!isLoding ? <div className='table-responsive px-4'>
        ...
        <thead className=''>
          <tr className=""> 
            ...
            <th className="theadTable" scope="col">User</th>
            <th className="theadTable" scope="col">Project</th>
